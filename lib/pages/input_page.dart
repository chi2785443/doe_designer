import 'package:doe_designer/components.dart';
import 'package:doe_designer/constants.dart';
import 'package:doe_designer/doe_calculation_brain.dart';
import 'package:doe_designer/pages/result_page.dart';
            ...
            cardChild: Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Divider(height: 10, color: Color(0xFFFF5252)),
                ),
                const Text(
                  'SLUMP VALUE',
                  style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),
                ...
                Row(
                  ...
                  children: [
                    Text(slump.toString(), style: kTextStyleBold),
                    const Text('mm', style: kTextStyle),
                  ],
                ),
                Slider(
          ...
          FlatCard(
            cardChild: Column(
              ...
              children: [
                ...
                const Padding(
                  padding: EdgeInsets.all(10.0),
                  child: Divider(height: 10, color: Color(0xFF757575)),
                ),
                const Text(
            ...
            cardChild: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  textBaseline: TextBaseline.alphabetic,
                  children: [
                    Text(percentagePassing.toString(), style: kTextStyleBold),
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => Result_Page(
                    standardDeviationResult: calc
                        .getStandardDeviation()
                        .toStringAsFixed(1),
                    defectiveResult: calc.getDefective().toString(),
                    targetMeanStrengthResult: calc
                        .getTargetMeanStrength()
                        .toStringAsFixed(1),
                    freeWaterRatioResult: calc
                        .getFreeWaterRatio()
                        .toStringAsFixed(2),
                    freeWaterContentResult: calc
                        .getFreeWaterContent()
                        .toStringAsFixed(0),
                    cementContentResult: calc
                        .getCementContent()
                        .toStringAsFixed(1),
                    wetdensityofConcretetResult: calc
                        .getWetdensityofConcrete()
                        .toStringAsFixed(1),
                    totalAggregateContentResult: calc
                        .getTotalAggregateContent()
                        .toStringAsFixed(1),
                    percentageofFineAggregateResult: calc
                        .getPercentageofFineAggregate()
                        .toStringAsFixed(1),
                    fineAggregateContentResult: calc
                        .getFineAggregateContent()
                        .toStringAsFixed(1),
                    coasreAggregateContentResult: calc
                        .getCoarseAggregateContent()
                        .toStringAsFixed(1),
                    cementRatioResult: calc.getCementRatio().toStringAsFixed(0),
                    fineAggRatioResult: calc.getFineAggRatio().toStringAsFixed(
                      0,
                    ),
                    coasreAggRatioResult: calc
                        .getCoarseAggRatio()
                        .toStringAsFixed(0),
                    rawCementRatioResult: calc.getCementRatio().toStringAsFixed(
                      1,
                    ),
                    rawFineAggRatioResult: calc
                        .getFineAggRatio()
                        .toStringAsFixed(1),
                    rawCoasreAggRatioResult: calc
                        .getCoarseAggRatio()
                        .toStringAsFixed(1),
                  ),
                ),
